export const data =  [
  ...
  },
  {
    ...
    poster_path: '/nS7DNl4A7XnDncZX70UJ8ALAihF.jpg',
    media_type: 'movie',
  ...
  {
    adult: false,
    backdrop_path: '/6M1MV30qqB90Stsylgq3Ytdh9um.jpg',
    id: 801965,
    title: 'Breaking',
    original_language: 'en',
    ...
    poster_path: '/lelrqRfGcCCHOeTsRXbOiyecFqC.jpg',
    media_type: 'movie',
    genre_ids: [80, 18, 53],
    popularity: 15.299,
  ...
  },
  {
    ...
    overview:
      "After more than thirty years of service as one of the Navy's top aviators, and dodging the advancement in rank that would ground him, Pete Mitchell finds himself training a detachment of TOP GUN graduates for a specialized mission the likes of which no living pilot has ever seen.",
  ...
  {
    adult: false,
    backdrop_path: '/3ylmB3cENHUGF5mePdmhe54Di9d.jpg',
    id: 604571,
    title: 'Deus',
    original_language: 'en',
    original_title: 'Deus',
    ...
    poster_path: '/zq9iHZTVNOXFT4SIzjpA7gfwsyZ.jpg',
    media_type: 'movie',
    genre_ids: [878, 53],
    popularity: 2.873,
  ...
  {
    adult: false,
    backdrop_path: '/kYJNrQ5say16fewLCdOVGjNpsX9.jpg',
    id: 747687,
    title: 'The Catholic School',
    original_language: 'it',
    original_title: 'La scuola cattolica',
    overview:
    ...
    poster_path: '/WTTXAtuyQY93oe1yetWYMGbO7K.jpg',
    media_type: 'movie',
    genre_ids: [18],
    popularity: 10.986,
